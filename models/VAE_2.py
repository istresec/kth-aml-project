...
print("Before preprocessing:", train_images.shape)
train_images = preprocess_images(train_images)
test_images = preprocess_images(test_images)
print("After preprocessing:", train_images.shape)
...
# Pick a sample of the best set for generating output images
...
for epoch in range(1, epochs + 1):
    ...
    test_elbo = -loss.result()
    # display.clear_output(wait=False)
    print(
        f"Epoch: {epoch}, Test set ELBO: {test_elbo}, Train set ELBO: {train_elbo}, time elapsed for current epoch: {end_time - start_time}")
